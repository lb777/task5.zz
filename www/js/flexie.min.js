var Flexie = function (H, R) {
    ...
    function ia(a, d) {
        a = "on" + a;
        var c = H[a];
        H[a] = typeof H[a] !== "function" ? d : function () {
            c && c();
            d()
        }
    }
    ...
    function ja(a) {
        ...
        if (a.id)d += "#" + a.id; else if (a.FLX_DOM_ID)d += "[" + ka + "='" + a.FLX_DOM_ID + "']";
        return d
    }
    ...
    function Ja(a) {
        var d, c, b, e, f = /\s?,\s?/, g, h, k, i = {}, n = {}, r, p, j, l, m, o, y, v;
        g = function (s, w, q, A) {
            var z, C, I;
            s = {
                selector: O(s),
            ...
            for (C = w.properties.length; z < C; z++) {
                I = w.properties[z];
                s.properties.push({property: O(I.property), value: O(I.value)})
            }
            if (q && A)s[q] = A;
            return s
        };
        h = function (s, w, q, A) {
            var z = q && A ? i[s] : n[s], C, I, P, L, t;
            if (z) {
                C = 0;
                ...
                if (q && A)z[q] = A
            } else if (q && A)i[s] = g(s, w, q, A); else n[s] = g(s, w, x, x)
        };
        r = 0;
        for (p = a.length; r < p; r++) {
            j = a[r];
            d = O(j.selector).replace(f,
                ",").split(f);
            l = 0;
            ...
            if (k.selector) {
                ...
                if (b[0]) {
                    ...
                    for (n = b.length; i < n; i++) {
                        r = b[i];
                        if (r.nodeName !== na)switch (r.nodeName.toLowerCase()) {
                            case "script":
                            case "style":
                            case "link":
                                break;
                            default:
                                if (r.parentNode === a) {
                                    ca(r);
                                    e = {};
                                    for (p in k)if (k.hasOwnProperty(p))e[p] = k[p];
                                    e.match = r;
                                    f.push(e)
                                }
                        }
    ...
    function pa(a, d) {
        var c, b, e = a.currentStyle && a.currentStyle[d], f = a.style;
    ...
    function D(a, d, c) {
        if (a !== na) {
            if (H.getComputedStyle)a = H.getComputedStyle(a, x)[d]; else if (La.test(d)) {
    ...
    function M(a, d, c) {
        var b =
            a && a[0] ? a : [a], e, f;
        e = 0;
        for (f = b.length; e < f; e++)if ((a = b[e]) && a.style)a.style[d] = c ? c + "px" : E
    }

    function Oa(a) {
        var d, c, b, e, f;
        a = a.replace(Pa, function (g, h) {
            return "%" + h
        }).replace(/\s|\>|\+|\~/g, "%").split(/%/g);
        ...
        for (e = a.length; b < e; b++) {
            f = a[b];
            if (/#/.test(f))c += d._id; else if (/\.|\[|\:/.test(f))c += d._class; else if (/[a-zA-Z]+/.test(f))c += d._tag
        }
        return c
    }
    ...
    function Qa(a, d, c) {
        d = [];
        var b, e = (c ? "ordinal" : "flex") + "Specificity", f, g, h, k, i, n;
        f = 0;
        ...
        for (k = d.length; h < k; h++) {
            ...
            for (r = a.length; n < r; n++) {
                ...
                if (c) {
                    ...
                    g = p.flex || "0";
                    if (p.match === i && (!p[g] || p[g] && parseInt(p[g], 10) <= 1)) {
                        f += parseInt(g,
                            10);
                        b[g] = b[g] || [];
                        b[g].push(p)
    ...
    function Ra() {
        if (!za) {
            var a, d, c, b, e = R.body, f = R.documentElement, g;
            ia("resize", function () {
                g && window.clearTimeout(g);
                g = window.setTimeout(function () {
                    c = H.innerWidth || f.innerWidth || f.clientWidth || e.clientWidth;
                    b = H.innerHeight || f.innerHeight ||
                    f.clientHeight || e.clientHeight;
                    if (a !== c || d !== b) {
    ...
    function Y(a, d) {
        var c = [], b, e, f;
        e = 0;
        for (f = d.length; e < f; e++)if (b = d[e])switch (b.nodeName.toLowerCase()) {
            case "script":
            case "style":
            case "link":
                break;
            default:
                if (b.nodeType === 1)c.push(b); else if (b.nodeType === 3 && (b.isElementContentWhitespace || Sa.test(b.data))) {
                    a.removeChild(b);
                    e--
                }
        }
    ...
    var J = {}, da = 0, ka = "data-flexie-id", $ = "data-flexie-parent", Q, Ca, V = {
            NW: {s: "*.Dom.select"},
            DOMAssistant: {s: "*.$", m: "*.DOMReady"},
            Prototype: {s: "$$", m: "document.observe", p: "dom:loaded", c: "document"},
            YAHOO: {s: "*.util.Selector.query", m: "*.util.Event.onDOMReady", c: "*.util.Event"},
            MooTools: {s: "$$", m: "window.addEvent", p: "domready"},
            Sizzle: {s: "*"},
            jQuery: {s: "*", m: "*(document).ready"},
            dojo: {s: "*.query", m: "*.addOnLoad"}
        }, T, qa = /^-?\d+(?:px)?$/i, Ka = /^-?\d/, La = /width|height|margin|padding|border/, Ua = /(msie) ([\w.]+)/,
        Va = /\t|\n|\r/g, Wa = /^max\-([a-z]+)/, Xa = /^https?:\/\//i, Ha = /^\s\s*/, Ia = /\s\s*$/, Sa = /^\s*$/, Pa = /\s?(\#|\.|\[|\:(\:)?[^first\-(line|letter)|before|after]+)/g, E = "", Da = " ", aa = "$1", sa = "paddingRight", va = "paddingBottom", ra = "paddingLeft", ea = "paddingTop", ua = "borderRightWidth", xa = "borderBottomWidth", ta = "borderLeftWidth", wa = "borderTopWidth", ya = " -o- -moz- -ms- -webkit- -khtml- ".split(Da), Ya = {
            orient: "horizontal",
            align: "stretch",
            direction: "inherit",
            pack: "start"
        }, B = [], la = [], ga, za, u = true, U = false, x = null, na, W = {
            IE: function () {
                var a,
    ...
    Ea = function () {
        function a(j) {
            return j.replace(k, function (l, m, o) {
                ...
                for (y = l.length; o < y; o++) {
                    v = l[o];
                    v.replace(i, aa).replace(n, aa).replace(p, aa).replace(r, Da)
                }
                return m + l.join(",")
            })
        }
        ...
        function b(j, l) {
            if (j) {
                if (Xa.test(j))return l.substring(0, l.indexOf("/", 8)) === j.substring(0, j.indexOf("/", 8)) ? j : x;
                if (j.charAt(0) === "/")return l.substring(0, l.indexOf("/", 8)) + j;
                var m = l.split("?")[0];
                if (j.charAt(0) !== "?" && m.charAt(m.length - 1) !== "/")m = m.substring(0, m.lastIndexOf("/") + 1);
                return m + j
            }
        }

        function e(j) {
            if (j)return c(j).replace(f,
                E).replace(g, function (l, m, o, y, v, s) {
                    l = e(b(o || v, j));
        ...
        var f = /(\/\*[^*]*\*+([^\/][^*]*\*+)*\/)\s*?/g, g = /@import\s*(?:(?:(?:url\(\s*(['"]?)(.*)\1)\s*\))|(?:(['"])(.*)\3))\s*([^;]*);/g, h = /(behavior\s*?:\s*)?\burl\(\s*(["']?)(?!data:)([^"')]+)\2\s*\)/g, k = /((?:^|(?:\s*\})+)(?:\s*@media[^\{]+\{)?)\s*([^\{]*?[\[:][^{]+)/g, i = /([(\[+~])\s+/g, n = /\s+([)\]+~])/g, r = /\s+/g, p = /^\s*((?:[\S\s]*\S)?)\s*$/;
        return function () {
            var j, l = [], m, o;
            m = R.getElementsByTagName("BASE");
            var y = m.length > 0 ? m[0].href : R.location.href, v = R.styleSheets, s, w;
            m = 0;
            ...
            m = 0;
            for (o = l.length; m < o; m++)if (j = l[m]) {
                if (j = b(j.href, y))s = a(e(j));
                if (s) {
                    w = s;
                    j = [];
                    v = void 0;
                    var q = void 0, A = void 0;
                    q = void 0;
                    A = void 0;
                    var z = void 0, C = void 0, I = void 0, P = void 0;
                    z = void 0;
                    w = w.replace(Va, E);
                    w = w.replace(/\s?(\{|\:|\})\s?/g, aa);
                    v = w.split("}");
                    for (I in v)if (v.hasOwnProperty(I))if (w = v[I]) {
                        q = [w,
                            "}"].join(E);
                        if ((A = /(\@media[^\{]+\{)?(.*)\{(.*)\}/.exec(q)) && A[3]) {
                            q = A[2];
                            A = A[3].split(";");
                            C = [];
                            for (P in A)if (A.hasOwnProperty(P)) {
                                z = A[P];
                                z = z.split(":");
                                z.length && z[1] && C.push({property: z[0], value: z[1]})
                            }
                            q && C.length && j.push({selector: q, properties: C})
                        }
                    }
                    w = j;
                    w = Ja(w)
                ...
                for (A = l.boxes.length; q < A; q++) {
                    ...
                    for (z = F.length; C < z; C++) {
                        ...
                        if (t.nodeType) {
                            ...
                            if (N = I[t.FLX_DOM_ID])for (K in G) {
                                if (G.hasOwnProperty(K)) {
                                    t = G[K];
                                    switch (K) {
                                        case "selector":
                                            if (t && !RegExp(t).test(N[K]))N[K] +=
                                                ", " + t;
                                            break;
                                        case "children":
                                            X = 0;
                                            for (S = G[K].length; X < S; X++) {
                                                ha = G[K][X];
                                                t = U;
                                                ba = 0;
                                                for (Fa = N[K].length; ba < Fa; ba++) {
                                                    Ga = N[K][ba];
                                                    if (ha.match.FLX_DOM_ID === Ga.match.FLX_DOM_ID)t = u
                                                }
                                                t || N[K].push(ha)
                                            }
                                            break;
                                ...
                                X = t.FLX_DOM_ID;
                                S = void 0;
                                for (S in G)if (G.hasOwnProperty(S))G[S] = G[S] || Ya[S];
                                N[X] = G;
    ...
    J.box.prototype = {
        properties: {
            boxModel: function (a, d, c) {
                ...
                if (!c.cleared) {
                    ...
                    for (g = d.length; f < g; f++) {
                        h = d[f];
                        if (b.addRule)if (W.IE < 8) {
                            a.style.zoom = "1";
                            if (W.IE === 6)b.addRule(h.replace(/\>|\+|\~/g, ""), e + "zoom:1;", 0); else W.IE === 7 && b.addRule(h, e + "display:inline-block;", 0)
                        } else {
                            b.addRule(h,
                                e, 0);
                            b.addRule(h + ":before", "content: '.';display: block;height: 0;overflow: hidden", 0);
                            b.addRule(h + ":after", "content: '.';display: block;height: 0;overflow: hidden;clear:both;", 0)
                        } else if (b.insertRule) {
                            b.insertRule(h + "{" + e + "}", 0);
                            b.insertRule(h + ":after{content: '.';display: block;height: 0;overflow: hidden;clear:both;}", 0)
                        }
                    }
                    c.cleared = u
                }
                ...
                var b, e, f;
                if (c.direction === "reverse" && !c.reversed || c.direction === "normal" && c.reversed) {
                    d = d.reverse();
                    b = 0;
                    for (e = d.length; b < e; b++) {
                        f = d[b];
                    ...
                    for (e = a.length; b < e; b++) {
                        d = a[b];
                        if ((d = B[d.FLX_DOM_ID]) && d.direction === "inherit")d.direction = c.direction
                    }
                ...
                if (!Q) {
                    ...
                    for (f = d.length; e < f; e++) {
                        ...
                        if (c.orient === "vertical" ||
                            c.orient === "block-axis")g.style.clear = "left";
                    ...
                    b = function (f) {
                        ...
                        for (h = f.length; g < h; g++) {
                            ...
                            for (n = d.length; i < n; i++) {
                                r = d[i];
                                k === r.getAttribute("data-ordinal-group") && a.appendChild(r)
                            }
                        }
                    };
                    e = Z(c.children, d, u);
                ...
                if (d.length) {
                        ...
                        for (p = k.length; r < p; r++) {
                            ...
                            for (m = i[j].length; l < m; l++) {
                                ...
                                for (v = o.properties.length; y < v; y++) {
                                    s = o.properties[y];
                                    if (Wa.test(s.property))n = parseFloat(s.value)
                                }
                                if (!n || o.match[b.props.out] > n)M(o.match, b.props.pos, x)
                            }
                        }
                    };
                    f = function (k) {
                    ...
                    g = function (k, i) {
                        var n = k.groups, r = k.keys, p, j, l = i.ration, m, o, y, v, s, w, q;
                        o = 0;
                        for (y = r.length; o < y; o++) {
                            ...
                            for (w = n[v].length; s < w; s++) {
                                ...
                                if (q.match) {
                                    ...
                                    j = q.match.getAttribute("data-specificity");
                                    if (!p || j <= q.flexSpecificity) {
                                        q.match.setAttribute("data-flex", v);
                                        q.match.setAttribute("data-specificity",
                                            q.flexSpecificity);
                ...
                b = Ba(a);
                var f, g, h, k, i;
                if (!Q && !b.flex && (c.orient === "vertical" || c.orient === "block-axis")) {
                    a:{
                        b = this.anti.dim;
                        f = a.parentNode;
                        if (f.FLX_DOM_ID) {
            ...
            var b, e;
            if (!(!a || !d || !c))if (Q && Q.partialSupport) {
                b = Z(c.children, d, x);
                e = Ba(a);
                d = Y(a, a.childNodes);
                this.properties.boxOrient.call(this,
                    a, d, c);
                if (!b.total || !T(c.nested).length) {
                    if (c.align === "stretch" && !Q.boxAlignStretch && (!e.nested || !e.flex))this.properties.boxAlign.call(this, a, d, c);
                    c.pack === "justify" && !Q.boxPackJustify && !b.total && this.properties.boxPack.call(this, a, d, c)
                }
            } else if (!Q)for (b in this.properties)if (this.properties.hasOwnProperty(b)) {
                d = this.properties[b];
            ...
            var d = this, c = a.target, b = c.childNodes;
    ...
    J.updateInstance = function (a, d) {
        var c, b;
        if (a)if (c = B[a.FLX_DOM_ID])c._instance.updateModel(c); else new J.box(d); else for (b in B)if (B.hasOwnProperty(b)) {
            c = B[b];
    ...
    J.destroyInstance = function (a) {
        ...
        if (a)(a = B[a.FLX_DOM_ID]) && d(a); else {
    ...
    J.flexboxSupport = function () {
        var a = {}, d, c = R.createElement("flxbox"), b, e, f;
        c.style.width = c.style.height = "100px";
        c.innerHTML = '<b style="margin: 0; padding: 0; display:block; width: 10px; height:50px"></b><b style="margin: 0; padding: 0; display:block; width: 10px; height:50px"></b><b style="margin: 0; padding: 0; display:block; width: 10px; height:50px"></b>';
        fa(c, "display", "box", x);
        ...
        b = {
            boxAlignStretch: function () {
                ...
                var g = 0, h, k;
                h = 0;
                for (k = c.childNodes.length; h < k; h++)g += c.childNodes[h].offsetLeft;
                return g === 135
            }
        };
    ...
    (function (a) {
        if (!Ca) {
            ...
            for (c in V)if (V.hasOwnProperty(c)) {
                b = V[c];
                if (H[c] && !d)if (d = eval(b.s.replace("*", c))) {
                    Ca = c;
                    break
                }
            }
